...
class CUB11(Dataset):
    ...
    def build_data_dict(self):
        ...
        if self.save_img:
            images = np.array( [np.array(Image.open(self.root_dir + '/images/' + line.split()[1]).resize(self.im_size).convert('RGB')) for line in path_content] )
    ...
    def __getitem__(self, idx):
        ...
        y, part_locs, vis_locs = self.data['y'][true_idx], self.data['part_locs'][true_idx], self.data['part_vis'][true_idx]
